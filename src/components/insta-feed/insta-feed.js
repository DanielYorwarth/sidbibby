...
const InstaFeed = ({token}) => {
    ...
    useEffect(() => {
      if(!token) return
      fetch(`https://graph.instagram.com/me/media?fields=id,caption,permalink,media_url,images,media_type,thumbnail_url&access_token=${token}&limit=5`)
  ...
  return (
    <div className="px-4 md:px-8 max-w-screen-2xl mx-auto">
      <div className="flex flex-wrap justify-between items-center mb-5">
        {gallery && <h3 className="text-3xl md:text-4xl text-primary-dark leading-tight mb-2 uppercase">the latest from our INSTAGRAM</h3>}
      </div>
