    ...
    <footer className="site-foot px-4 md:px-8 relative z-10 max-w-screen-2xl mx-auto">
      ...
      <div className="lg:flex flex-wrap justify-between text-xs max-w-screen-2xl mx-auto py-4 md:py-8 w-full">
        <div className="mb-4 lg:mb-0">
          © {new Date().getFullYear()} SID BIBBY TURF AND LANDSCAPING LTD <span className="px-2 hidden md:inline-block">|</span> <span className="block md:inline-block">DESIGNED BY <a rel="noopener" target="_blank" href="https://volley.digital" className="pl-2 font-bold text-secondary">VOLLEY DIGITAL</a></span>
        </div>
        <div>
