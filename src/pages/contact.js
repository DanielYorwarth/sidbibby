    ...
    <Layout>
      ...
      <div className="max-w-screen-2xl mx-auto px-4 md:px-8 mb-12 md:mb-24 flex flex-wrap">
        <div className="w-full md:w-2/3 bg-gray">
          ...
          <form className="flex flex-wrap" name="contact" method="POST" data-netlify="true">
            ...
            <p className="w-full mb-4">
              <label><textarea  placeholder="Message" className="p-4" rows="8" name="message"></textarea></label>
            </p>
            <p>
